...
only to the data in the small inner window, like using a moving
average to calculate anomaly values instead of a monthly mean.  These
...
boxplot(mx,  pch='.', boxwex=1, outline=FALSE,
	main="Monthly window", ylab=units)
boxplot(dox, pch='.', boxwex=1, outline=FALSE, main="30-day moving window",
...
plot(doy, dayanom-monanom, pch=".",
     main="Anomaly difference", ylab=units, xlab="day of year")
