...
## align epochs
bctime$fut <- bctime$fut - 365*2
bctime$cur <- bctime$cur - 365*2
bctime$obs <- bctime$obs - 365*30 - 22

## ?? Not sure what the 22 is about, but this is just hacking around,
## so it doesn't matter

ocfcol <- c(obs="black", cur="blue", fut="red")

#par(mfrow=c(3,1))
#matplot(as.matrix(bctime), as.matrix(bcdata), col=ocfcol, pch=1)

## Okay.  This plot doesn't work.  Need boxplots for segments.  So
## need segments
